...
func TestPhTables(t *testing.T) {
	...
	tu.AssertEqual(t, wrapper3.Box().Style.GetMarginLeft(), pr.TagToV(pr.Auto))
	tu.AssertEqual(t, wrapper3.Box().Style.GetMarginRight(), pr.TagToV(pr.Auto))
	...
	th := unpack1(head)
	tu.AssertEqual(t, th.Box().Style.GetVerticalAlign(), pr.TagToV(pr.Top))
...
func TestPhHr(t *testing.T) {
	...
	tu.AssertEqual(t, hr1.Box().Style.GetMarginRight(), pr.TagToV(pr.Auto))
	tu.AssertEqual(t, hr2.Box().Style.GetMarginLeft(), pr.TagToV(pr.Auto))
	tu.AssertEqual(t, hr2.Box().MarginRight, Fl(0))
	tu.AssertEqual(t, hr3.Box().Style.GetMarginLeft(), pr.TagToV(pr.Auto))
	tu.AssertEqual(t, hr3.Box().Style.GetMarginRight(), pr.TagToV(pr.Auto))
	tu.AssertEqual(t, hr3.Box().Style.GetColor(), pr.NewColor(1, 0, 0, 1))
	tu.AssertEqual(t, hr4.Box().Style.GetMarginLeft(), pr.TagToV(pr.Auto))
	tu.AssertEqual(t, hr4.Box().Style.GetMarginRight(), pr.TagToV(pr.Auto))
...
func TestPhEmbedded(t *testing.T) {
	...
	tu.AssertEqual(t, embed.Box().Style.GetVerticalAlign(), pr.TagToV(pr.TextTop))
	tu.AssertEqual(t, object.Box().Style.GetVerticalAlign(), pr.TagToV(pr.Top))
